...
public interface RequestArgService extends BaseService<RequestArgEntity> {
    ...
    BaseResult addRequestArg(String pid, String name,String defValue, int type, String projectId, String interfaceId, String note, String userId, boolean isRequire, boolean isGlobal);

    BaseResult updateRequestArg(String pid, String requestArgId, String name,String defValue, int type, String interfaceId, String note, String userId, boolean isRequire, boolean isGlobal);
