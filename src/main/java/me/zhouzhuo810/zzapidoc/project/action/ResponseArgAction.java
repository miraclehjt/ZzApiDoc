...
public class ResponseArgAction extends BaseController<ResponseArgEntity> {
    ...
    public BaseResult addResponseArg(
        ...
        return getService().addResponseArg(pid, name, type, projectId, interfaceId, note, userId);
    }
    ...
    public BaseResult updateResponseArg(
        ...
        return getService().updateResponseArg(pid, responseArgId, name, type, interfaceId, note, userId);
    }
    ...
    public BaseResult getResponseArgByInterfaceIdAndPid(
        ...
        return getService().getResponseArgByInterfaceIdAndPid(interfaceId, pid, userId);
    }
